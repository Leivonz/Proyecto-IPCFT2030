    ...
    public partial class SereDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=SQL5109.site4now.net;Initial Catalog=db_a4cc73_seredb;Persist Security Info=False;User ID=db_a4cc73_seredb_admin;Password=Sere2022DB;Connection Timeout=30;");
