USE db_a4cc73_seredb
GO
/****** Object:  Database [SereDb]    Script Date: 7/4/2022 10:56:13 PM ******/
CREATE DATABASE [db_a4cc73_seredb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'SereDb', FILENAME = N'F:\IPCFT2030\web\full\Database\SEREdb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'SereDb_log', FILENAME = N'F:\IPCFT2030\web\full\Database\SereDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [db_a4cc73_seredb] SET COMPATIBILITY_LEVEL = 150
GO
...
GO
ALTER DATABASE [db_a4cc73_seredb] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET ARITHABORT OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [db_a4cc73_seredb] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [db_a4cc73_seredb] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [db_a4cc73_seredbb] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET  ENABLE_BROKER 
GO
ALTER DATABASE [db_a4cc73_seredb] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [db_a4cc73_seredb] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [db_a4cc73_seredb] SET  MULTI_USER 
GO
ALTER DATABASE [db_a4cc73_seredb] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [db_a4cc73_seredb] SET DB_CHAINING OFF 
GO
ALTER DATABASE [db_a4cc73_seredb] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [db_a4cc73_seredb] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [db_a4cc73_seredb] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [db_a4cc73_seredb] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [db_a4cc73_seredb] SET QUERY_STORE = OFF
GO
USE [db_a4cc73_seredb]
GO
...
USE [db_a4cc73_seredb]
GO
ALTER DATABASE [db_a4cc73_seredb] SET  READ_WRITE 
GO
